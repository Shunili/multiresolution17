...
In general, pMMF is only an approximation algorithm. Essentialy, it tries to solve this optimization problem
...
\subsection{Multiresolution of function spaces}
